"""
Django settings for activity_test_6 project.
...
ROOT_URLCONF = 'activity_test_6.urls'
...
WSGI_APPLICATION = 'activity_test_6.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Activity Test Support <support@activity-test-6.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "activity_test_6 API",
    "DESCRIPTION": "API documentation for activity_test_6 App",
    "VERSION": "v1",
}
